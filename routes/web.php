...
Route::get('user', 'UserController@manage_users');
Route::resource('get_users','UserController');
Route::get('role', 'UserController@manage_role');
Route::resource('get_role','RoleController');
    //	User controller
